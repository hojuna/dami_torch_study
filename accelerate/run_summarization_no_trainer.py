...
# accelerate launch accelerate/run_summarization_no_trainer.py     --model_name_or_path google-t5/t5-small     --dataset_name cnn_dailymail     --dataset_config "3.0.0"     --source_prefix "summarize: "     --output_dir ~/tmp/tst-summarization
"""
